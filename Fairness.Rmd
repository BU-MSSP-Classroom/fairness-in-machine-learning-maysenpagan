...
~~~
We will be working the COMPAS data set.
...
~~~
The favorable label is "low" recidivism risk and the favorable label grant is non-punitive as it is simply someone not getting arrested again if they were to receive parole.
...
~~~
This issue is about distributive as well as procedural justice. The issue is whether the profiling has bias towards certain protected groups. So we are interested in what recidivism risk group they are placed in and were they placed in the different risk groups in the same way, or is there bias in the predictions based on race.
